...
<section
      ...
      style="background: url({{ asset($blog_details->banner_image) }});object-fit:cover"
    >
      <div class="container">
        <div class="row">
          <div class="col-12">
...
<div class="text-center">
    <div class="">
      <ul class="page-breadcrumb">
           ...
           <li><a href="#" class="text-danger fw-bolder">{{ $blog_details->title_english }}</a></li>
        </ul>
     </div>
  </div>
 ...
 <!--================================
    ...
    <section class="tf__blog_details pt_120 xs_pt_80 pb_120 xs_pb_80">
        <div class="container">
          ...
          <div class="row">
            <h1 class="text-center py-3 fw-bold" style="margin-top:-80px;">{{ $blog_details->title_english }}</h1>
            <div class="col-xl-12 col-lg-12 col-md-12">
              <div class="mx-auto d-block mb-3" style="width:740px;height:330px">
                <img src="{{ asset($blog_details->main_image) }}" class="img-thumbnail img-fluid " alt="Service">
              </div>
            </div>
            <div class="col-xl-12 col-lg-12 col-md-12">
              {!! $blog_details->short_des_eng !!}
            </div>
          </div>
          <div class="row py-3">
            <div class="col-xl-8 col-lg-8">
              <div class="tf__blog_details_area">
                <div class="tf__blog_details_img py-4 mt-2">
                  <img
                    src="{{ asset($blog_details->details_image1) }}"
                    alt="blog"
                ...
                <div class="tf__blog_details_text mt-3">                
                  {!! $blog_details->long_des1_eng !!}
                  
                </div>
                <div class="tf__blog_details_img mt-3">
                  <img
                    src="{{ asset($blog_details->details_image2) }}"
                    alt="blog"
                    class="img-fluid img-thumbnail rounded w-100"
                  />
                </div>
                ...
                <div class="tf__blog_details_text mt-3">                
                  {!! $blog_details->long_des2_eng !!}
                  
                </div>
                <div class="tf__blog_details_img mt-3">
                  <img
                    src="{{ asset($blog_details->details_image3) }}"
                    alt="blog"
                    class="img-fluid img-thumbnail rounded w-100"
                  />
                </div>
            ...
            <div class="col-xl-4 col-lg-4">
              <div class="tf__sidebar">
                ...
                @php
                  ...
                  $all_blogs = App\Models\Blog::latest()->limit(3)->get();
                @endphp
                      ...
                      <li>
                        <div class=" " >
                          <img
                            ...
                            alt="comment"
                            class="img-fluid rounded w-100 d-block m-auto" style="height:150px;"
                          />
