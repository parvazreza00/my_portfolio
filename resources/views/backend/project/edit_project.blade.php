                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <a href="{{ route('all.project') }}" class="btn btn-primary rounded-pill waves-effect waves-light"><i class="fe-arrow-left"></i>All Blogs</a>                            
                        </ol>
                    </div>
                            ...
                            <div class="row">                  
                                <div class="col-lg-6">                      
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="title_english" id="title_english" class="form-control" placeholder="Blogs Title In English..." value="{{ $edit_project->title_english }}">
                                ...
                                <div class="col-lg-6"> 
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="title_bangla" name="title_bangla" class="form-control" placeholder="Blogs Title In Bangla ..." value="{{ $edit_project->title_bangla }}">
                                    </div>
                                </div> 
                                <div class="col-lg-6"> 
                                    <div class="form-group mb-3">
                                    ...
                                    <img src="{{ (!empty($edit_project->main_image)) ? asset($edit_project->main_image) : url('upload/no_image.jpg') }}" alt="" id="main_image_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                ...
                                <div class="col-lg-6"> 
                                    ...
                                    <img src="{{ (!empty($edit_project->banner_image)) ? asset($edit_project->banner_image) : url('upload/no_image.jpg') }}" alt="" id="banner_image_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                ...
                                <div class="col-lg-4"> 
                                    ...
                                    <img src="{{ (!empty($edit_project->details_image1)) ? asset($edit_project->details_image1) : url('upload/no_image.jpg') }}" alt="" id="details_image1_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                ...
                                <div class="col-lg-4"> 
                                    ...
                                    <img src="{{ (!empty($edit_project->details_image2)) ? asset($edit_project->details_image2) : url('upload/no_image.jpg') }}" alt="" id="details_image2_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                ...
                                <div class="col-lg-4"> 
                                    ...
                                    <img src="{{ (!empty($edit_project->details_image3)) ? asset($edit_project->details_image3) : url('upload/no_image.jpg') }}" alt="" id="details_image3_show" class="avatar-lg img-thumbnail" alt="profile-image" style="width: 120px;height:120px">
                                ...
                                <div class="col-lg-12 mt-2"> 
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="long_des1_bng" id="tinymce" class="editor form-control" cols="30" rows="15" placeholder="Service Long Details-1 Bangla...">
                                            {!! $edit_project->long_des1_bng??null !!}
                                        </textarea> 
