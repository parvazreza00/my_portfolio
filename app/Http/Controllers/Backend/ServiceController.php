...
class ServiceController extends Controller
{
    ...
    public function tech_web_service_store(Request $request)
    {
        ...
        if ($request->hasFile('main_image')) {
            ...
            Image::make($main_image)->resize(740, 330)->save('backend/service/main_image/' . $main_image_name);
        ...
        if ($request->hasFile('detais_image_1')) {
            ...
            Image::make($detais_image_1)->resize(690, 410)->save('backend/service/details_images/' . $detais_image_1_name);
        ...
        if ($request->hasFile('detais_image_2')) {
            ...
            Image::make($detais_image_2)->resize(690, 410)->save('backend/service/details_images/' . $detais_image_2_name);
        ...
        if ($request->hasFile('detais_image_3')) {
            ...
            Image::make($detais_image_3)->resize(690, 410)->save('backend/service/details_images/' . $detais_image_3_name);
