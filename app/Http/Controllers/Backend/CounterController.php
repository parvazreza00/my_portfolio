    ...
    public function tech_web_counter_image_store(Request $request){
        ...
        if($counter_image){
            ...
            if($request->file('image_1')){
                ...
                Image::make($image_1)->resize(40,40)->save('backend/counter_image/'.$image_1_Name); 
            ...
            if($request->file('image_2')){
                ...
                Image::make($image_2)->resize(40,40)->save('backend/counter_image/'.$image_2_Name); 
            ...
            if($request->file('image_3')){
                ...
                Image::make($image_3)->resize(40,40)->save('backend/counter_image/'.$image_3_Name); 
            ...
            if($request->file('image_4')){
                ...
                Image::make($image_4)->resize(40,40)->save('backend/counter_image/'.$image_4_Name); 
